...
--- Необходимо категоризовать объявления по времени активности и вычислить для каждой категории следующие показатели: --
--- средняя стоимость кв.м., средняя площадь, медианное кол-во комнат, медианное кол-во балконов, медиана этажности---
WITH limits AS
( SELECT  
...
--- Выявить периоды с повышенной активностью продавцов и покупателей, а также оценить характеристики недвижимости в разные сезоны. ---
...
-- Расчет параметров с разбивкой по городам Ленобласти: количество объявлений, медианная длительность продажи, ---
-- доля проданных квартир, доля от общего количества объявлений, средняя цена, средняя площадь, медианное кол-во комнат ----
